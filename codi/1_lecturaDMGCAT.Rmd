...
```{r mostra, include = FALSE}

# list.files(here::here("dades/SIDIAP"))
# 
# generar_mostra_fitxers(directori = directori_dades,
#                        fitxer_poblacio="EPIDMGCAT_entregable_poblacio_20210222_142117.rds",
#                        mida_mostra = 5000,
#                        prefix = "test",
...
dt_poblacio<-readRDS(here::here(directori_dades,"EPIDMGCAT_entregable_poblacio_20210222_142117.rds"))
...
dt_cataleg<-readRDS(here::here("dades","EPIDMGCAT_entregable_cataleg_20210222_142117.rds"))
dt_poblacio<-readRDS(here::here(directori_dades,"EPIDMGCAT_entregable_poblacio_20210222_142117.rds")) %>% as_tibble()
dt_vars_assir<-readRDS(here::here(directori_dades,"EPIDMGCAT_entregable_variables_assir_20210222_142117.rds" )) %>% as_tibble()


# dt_diagnostics_HOSP<-readRDS(here::here(directori_dades,"epiPEUCAT_entregable_cmbdh_diagnostics_20200206_104913.rds")) %>% as_tibble()
# dt_diagnostics_AP<-readRDS(here::here(directori_dades,"epiPEUCAT_entregable_diagnostics_20200206_104913.rds")) %>% as_tibble()
# dt_derivacions<-readRDS(here::here(directori_dades,"epiPEUCAT_entregable_derivacions_20200206_104913.rds")) %>% as_tibble()
# dt_facturacio<-readRDS(here::here(directori_dades,"epiPEUCAT_entregable_farmacs_facturats_20200206_104913.rds")) %>% as_tibble()
# dt_poblacio<-readRDS(here::here(directori_dades,"epiPEUCAT_entregable_poblacio_20200206_104913.rds")) %>% as_tibble()
# dt_tabaquisme<-readRDS(here::here(directori_dades,"epiPEUCAT_entregable_tabaquisme_20200206_104913.rds")) %>% as_tibble()
# dt_analitiques<-readRDS(here::here(directori_dades,"epiPEUCAT_entregable_variables_analitiques_20200206_104913.rds")) %>% as_tibble()
# dt_cliniques<-readRDS(here::here(directori_dades,"epiPEUCAT_entregable_variables_cliniques_20200206_104913.rds")) %>% as_tibble()
